import { convertMMSS, scripts, settings } from "hackingSuite/common.js";
import { unlock } from "hackingSuite/scripts/serverOperations/breakIn.js";
...
export class Server {
     ...
     * @returns {import("typings/index").ProcessInfo[]} ProcessInfo[] of all processes running on the server
     */
    get ps() {
     ...
     * @param {string} source
     */
    async transferFiles(files, source) {
        await this.ns.scp(files, source, this.hostname);
    }
